<template>
  ...
  >
    ...
    <div class="flex justify-center flex-col grow py-10">
      <div v-html="childhoodText" class="text-trigger w-9/12 m-auto"></div>
    </div>
  </div>
</template>
...
const { childhoodText } = defineProps(["childhoodText"]);
